...
const updateMood_1 = __importDefault(require("./routes/updateMood"));
const addQuote_1 = __importDefault(require("./routes/addQuote"));
const fetchQuotes_1 = __importDefault(require("./routes/fetchQuotes"));
const getMoodForUser_1 = __importDefault(require("./routes/getMoodForUser"));
...
const getEntry_1 = __importDefault(require("./routes/getEntry"));
const addEntry_1 = __importDefault(require("./routes/addEntry"));
const removeEntry_1 = __importDefault(require("./routes/removeEntry"));
const updateEntry_1 = __importDefault(require("./routes/updateEntry"));
...
app.use(addEntry_1.default);
app.use(getEntry_1.default);
app.use(deleteHabit_1.default);
app.use(updateHabit_1.default);
app.use(removeEntry_1.default);
app.use(updateEntry_1.default);
app.use(removeFriend_1.default);
app.use(updateFriend_1.default);
app.use(updateMood_1.default);
app.use(getUsers_1.default);
app.use(addQuote_1.default);
app.use(fetchQuotes_1.default);
app.use(getMoodForUser_1.default);
app.get('*', (req, res) => {
