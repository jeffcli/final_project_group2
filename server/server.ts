...
import getEntry from "./routes/journal/getEntry";
import addEntry from "./routes/journal/addEntry";
import removeEntry from "./routes/journal/removeEntry";
import updateEntry from "./routes/journal/updateEntry";
